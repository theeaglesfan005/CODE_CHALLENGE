...
def get_discounts(nums, d)
  nums.map! { |n| n = n*(d.chop.to_i / 100.0) }
end

puts get_discounts([2, 4, 6, 11], "50%") == [1, 2, 3, 5.5]
puts get_discounts([10, 20, 40, 80], "75%") == [7.5, 15, 30, 60]
puts get_discounts([100], "45%") == [45]