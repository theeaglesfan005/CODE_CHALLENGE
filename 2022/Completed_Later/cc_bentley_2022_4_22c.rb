# Medium - Check if One Array is a Subset of Another
#
...
puts subset([1, 3], [1, 3, 3, 5]) == true
puts subset([4, 8, 7], [7, 4, 4, 4, 9, 8]) == true
puts subset([1, 3], [1, 33]) == false
puts subset([1, 3, 10], [10, 8, 8, 8]) == false
puts subset([5, 9, 13], [13, 9, 5]) == true
puts subset([5, 9, 13], [13, 9, 5, 1, 1, 1]) == true
puts subset([5, 9, 13], [13, 5, 1, 1, 1]) == false